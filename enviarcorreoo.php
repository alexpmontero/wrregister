<?php
  ...
  $email = $_POST['email'];
  $asunto = $_POST['asunto'];
  $org_certificada = $_POST['org_certificada'];
  ...
  if(trim($nya) == '') {
    ...
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Por favor, ingresa tus Nombre completo.</div>';
  ...
  /*
  if($formatoImagen != "jpg" && $formatoImagen != "png" && $formatoImagen != "gif" && $formatoImagen != "pdf" && $_FILES['img']['size'] != 0) {
      $uploadOk = 0;
...
// Subimos la imagen
  ...
  $nuevonombreimagen = str_replace(' ', '',$_FILES["img"]["name"]);
...
$e_bodyf = "<p><b>Asunto:</b> $e_asunto" . PHP_EOL . PHP_EOL . "</p>";
$e_bodyi = "<p><b>Certificado:</b> $archivo"  . PHP_EOL . PHP_EOL . "</p>";
$e_reply = "<p><b>Email:</b> $email" . PHP_EOL . PHP_EOL . "</p>";
$norma = "<p></p><p><b>Norma:</b> $norma" . PHP_EOL . PHP_EOL . "</p>";
$no_cert = "<p><b>No. de certificado:</b> $no_certificado" . PHP_EOL . PHP_EOL . "</p>";
$org_cert = "<p><b>Organización certificada:</b> $org_certificada" . PHP_EOL . PHP_EOL . "</p>";
$e_bodyc = "<p><b>Mensaje:</b> $mensaje" . PHP_EOL . PHP_EOL . "</p>";

$msg = wordwrap( $e_bodya . $e_bodyg . $e_bodyd . $e_bodye . $e_bodyf . $e_bodyi . $e_bodyc . $norma . $no_cert . $org_cert . $e_reply, 80 );
...
//Attaching a file
$mensagem .= "Content-Type: ". $fileType ."; name=\"". $archivo . "\"" . PHP_EOL;
